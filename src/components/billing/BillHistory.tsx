...
const BillHistory: React.FC<BillHistoryProps> = ({ billHistory: initialBillHistory }) => {
  ...
  const handleBillClick = (bill: BillHistoryItem) => {
          ...
          {isLoading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
              {billHistory.map((bill) => (
                <div 
                  key={bill.id} 
                  className="border border-purple-100 dark:border-purple-800/30 rounded-md p-4 hover:bg-purple-50 dark:hover:bg-purple-900/20 transition-colors cursor-pointer"
